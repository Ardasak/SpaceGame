...
background = pygame.image.load("uzay.png")
...
bullet1 = pygame.image.load("bullet - Kopya.png")
bullet1x = player1x
bullet1y = player1y
bullet1_state = "ready"
...
def isCollision(player2x,player2y,bullet1x,bullet1y):
    distance = (math.sqrt(math.pow(player2x-bullet1x,2))) + (math.pow(player2y-bullet1y,2))
    if distance < 27:
        explosionsound.play()
        return True
...
def isCollision1(player1x,player1y,bullet2x,bullet2y):
    distance1 = (math.sqrt(math.pow(player1x - bullet2x,2))) + (math.pow(player1y - bullet2y,2))
    if distance1 < 27:
        explosionsound.play()
        return True
...
while run:
    ...
    ellipse = pygame.draw.ellipse(ekran,(255,255,255),(385,290,100,50))
    ekran.blit(starttext,(centered))
    ...
    if start:
        ...
        if score >= 3 or score1 >= 3:
            ...
            if score>=3:
                ...
                ekran.blit(player1Img,(650,400))
            elif score1>=3:
                score=-999
                ekran.blit(p2win,(300,200))
                winner = Font1.render("Winner",1,(255,255,255))
                ekran.blit(winner,(70,300))
                ekran.blit(reversedplayer2,(80,400))
                ekran.blit(winner,(640,300))
                ekran.blit(reversedplayer2,(650,400))

            if event.type == pygame.MOUSEBUTTONDOWN and 390 < mouse[0] < 490 and 290 < mouse[1] < 340:
                pygame.quit()
                quit()
        ...
        if collusion1:
            ...
            if event.type==pygame.MOUSEBUTTONDOWN and 10<mouse[0]<110 and 20<mouse[1]<70:
                pygame.quit()
                quit()
